      ...
      <div className="relative max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          <div className="space-y-6">
            ...
            <motion.div className="bg-slate-800/30 backdrop-blur-sm rounded-2xl border border-slate-700/50 p-6 mb-6" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.5 }}><TraitSelector /></motion.div>
            <motion.div className="bg-slate-800/30 backdrop-blur-sm rounded-2xl border border-slate-700/50 p-6 mt-6" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.6 }}>
