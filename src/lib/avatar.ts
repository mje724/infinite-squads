...
export const AVATAR_TRAITS: Record<string, AvatarTraits> = {
  ...
  'Lionel Pessi': { bg: '#75aadb', skin: '#e0b28a', hair: 'wavy', hairColor: '#3a2a1a', facial: 'full', eyes: 'normal', mouth: 'smile', prop: '⚽' },
  'Cristiano Penaldo': { bg: '#c9302c', skin: '#d9a06a', hair: 'slick', hairColor: '#1a1a1a', facial: 'none', eyes: 'smug', mouth: 'grin', prop: '🦵' },
  'Usain Jolt': { bg: '#2a8a3a', skin: '#5a3a20', hair: 'buzzcut', hairColor: '#000', facial: 'stubble', eyes: 'smug', mouth: 'grin', prop: '⚡' },
  ...
  'Wayne Gretzkee': { bg: '#2a4a8a', skin: '#e6c39a', hair: 'wavy', hairColor: '#d9c98a', facial: 'none', eyes: 'normal', mouth: 'smile', prop: '🏒' },
  ...
  'Slim Shadey': { bg: '#2a2a2a', skin: '#e6c39a', hair: 'buzzcut', hairColor: '#d9c98a', facial: 'none', eyes: 'angry', mouth: 'neutral', prop: '🍝' },
  ...
  'Willie Nelsong': { bg: '#8a3a2a', skin: '#d9a878', hair: 'ponytail', hairColor: '#c94f2a', facial: 'full', eyes: 'sleepy', mouth: 'smile', prop: '🌿' },
