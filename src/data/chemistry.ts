...
const NAMED_DUOS: NamedDuo[] = [
  ...
  { pair: ['Nikola Tesla', 'Elizabeth Homes'], name: 'Investor Beware', bonus: -6 },
  { pair: ['Rasputin', 'Prime Rasputin'], name: 'Temporal Anomaly', bonus: 9 },
  { pair: ['Bulk Hogan', 'Mike Tyzon'], name: 'Crossover Event', bonus: 6 },
  { pair: ['Air Goatness', 'Dennis Rodzilla'], name: 'Ring Chemistry', bonus: 8 },
  { pair: ['Lionel Pessi', 'Cristiano Penaldo'], name: 'The Eternal Debate', bonus: -5 },
  { pair: ['Tailor Quick', 'The Hive Queen'], name: 'Stadium Summit', bonus: 7 },
  { pair: ['Slim Shadey', 'Drayke'], name: 'Diss Track Pending', bonus: -5 },
  { pair: ['Elvis Presley', 'Freddie Mercury'], name: 'Kings Of The Stage', bonus: 7 },
  { pair: ['David Bowie', 'Prince'], name: 'Alien Royalty', bonus: 7 },
  { pair: ['Willie Nelsong', 'Snoop Doggo'], name: 'Botany Club', bonus: 8 },
  // Internet lore
  ...
  { pair: ['Lag', 'Speedrun Kid'], name: 'Run Killer', bonus: -8 },
  { pair: ['Lag', 'The Wi-Fi Router'], name: 'Total Outage', bonus: 7 },
  { pair: ['The Algorithm', 'NPC Streamer'], name: 'Boosted', bonus: 7 },
  { pair: ['The Algorithm', 'Doomscroller'], name: 'Perfect Victim', bonus: 6 },
  { pair: ['Twitch Chat', 'NPC Streamer'], name: 'Gift Sub Avalanche', bonus: 6 },
  { pair: ['Rage Quitter', 'Lag'], name: 'It Was The Lag', bonus: 5 },
  { pair: ['Final Boss', 'Tutorial Boss'], name: 'Career Ladder', bonus: 5 },
  { pair: ['The Backlog', 'The Completionist'], name: 'Unstoppable vs Immovable', bonus: -4 },
  { pair: ['Monday', 'Student Loans'], name: 'The Grind Alliance', bonus: 7 },
  { pair: ['Printer At Work', 'The Wi-Fi Router'], name: 'IT Ticket Storm', bonus: 6 },
  { pair: ['Autocorrect', 'Reply Guy'], name: 'Duck You Too', bonus: 4 },
