...
export const CARD_REGISTRY: Record<string, CardGameData> = {
  ...
  'Keanu Reevos': d('modern', ['wholesome', 'entertainer'], 80, 60, 92, 15, 85, 90),
  'Donny DeVito': d('modern', ['entertainer', 'chaos'], 35, 65, 90, 75, 70, 85),
  'Nicolas Kage': d('modern', ['entertainer', 'chaos'], 55, 55, 70, 97, 75, 84),
  'Snoop Doggo': d('modern', ['musician', 'entertainer'], 40, 70, 94, 55, 80, 92),
  'Gordon Ramzay': d('modern', ['entertainer', 'villain'], 60, 80, 60, 70, 75, 88),
  'Shaqster': d('modern', ['athlete', 'entertainer'], 98, 55, 90, 50, 80, 92),
  'Marfa Stewart': d('modern', ['hustler', 'entertainer', 'survivor'], 30, 88, 75, 40, 85, 82),
  'Mike Tyzon': d('modern', ['athlete', 'chaos'], 99, 45, 55, 85, 95, 90),
  'Odd Al': d('modern', ['musician', 'entertainer', 'wholesome'], 30, 85, 80, 65, 70, 78),
  'Guy Fiori': d('modern', ['entertainer', 'wholesome'], 50, 55, 88, 45, 75, 80),
  ...
  'Joe Rogain': d('internet', ['entertainer', 'internet'], 75, 50, 70, 65, 80, 85),
  'DJ Kaled': d('modern', ['musician', 'hustler'], 45, 40, 80, 55, 60, 82),
  'Tommy Weisau': d('modern', ['artist', 'chaos'], 40, 30, 55, 92, 80, 72),
  'Gary Buseye': d('modern', ['entertainer', 'chaos'], 55, 25, 50, 95, 78, 60),
  'Charlie Sheenz': d('modern', ['entertainer', 'chaos'], 45, 40, 70, 90, 65, 75),
  'Flavor Flame': d('modern', ['musician', 'entertainer', 'chaos'], 40, 45, 82, 80, 70, 78),
  'Bulk Hogan': d('modern', ['athlete', 'entertainer'], 94, 35, 80, 60, 90, 88),
  'Ozzy Ozzborne': d('modern', ['musician', 'chaos', 'survivor'], 50, 30, 70, 92, 94, 86),
  'Arnold Schwarzenagger': d('modern', ['athlete', 'entertainer', 'ruler'], 96, 65, 80, 35, 88, 92),
  ...
  'Elizabeth Homes': d('internet', ['hustler', 'villain'], 20, 78, 82, 45, 70, 75),
  ...
  'Main Character': d('internet', ['internet', 'entity', 'entertainer'], 65, 70, 95, 85, 80, 99),
  ...
  'Lionel Pessi': d('modern', ['athlete', 'wholesome'], 80, 92, 70, 25, 88, 98),
  'Cristiano Penaldo': d('modern', ['athlete', 'entertainer'], 92, 75, 80, 45, 92, 98),
  'Usain Jolt': d('modern', ['athlete', 'entertainer'], 94, 55, 85, 40, 80, 92),
  'Serena Willpower': d('modern', ['athlete'], 93, 80, 75, 35, 94, 94),
  'Lion Woods': d('modern', ['athlete', 'survivor'], 85, 82, 60, 55, 90, 93),
  'Wayne Gretzkee': d('modern', ['athlete', 'genius'], 75, 95, 65, 20, 80, 92),
  ...
  'Slim Shadey': d('modern', ['musician', 'chaos'], 45, 90, 55, 85, 80, 93),
  'Drayke': d('internet', ['musician', 'internet'], 40, 70, 78, 60, 60, 92),
  'Bad Rabbit': d('modern', ['musician', 'entertainer'], 50, 65, 88, 55, 70, 93),
  'Willie Nelsong': d('modern', ['musician', 'survivor', 'wholesome'], 35, 60, 90, 55, 95, 88),
