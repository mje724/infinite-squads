...
export const PRESET_CARDS: PresetCard[] = [
    ...
    rarity: 'silver', image: getImageUrl('Harambe') },
  {
    ...
    rarity: 'silver', image: getImageUrl('Killdozer') },
  {
    ...
    rarity: 'gold', image: getImageUrl('Boeing Door Plug') },
    ...
    rarity: 'silver', image: getImageUrl('Nikola Tesla') },
  {
    ...
    rarity: 'bronze', image: getImageUrl('Diogenes') },
  {
    name: 'Rasputin',
    ...
    rarity: 'bronze', image: getImageUrl('Hunter S. Thompson') },
  {
    ...
    rarity: 'gold', image: getImageUrl('Yusuf Dilek') },
    ...
    rarity: 'gold', image: getImageUrl('Genghis Khan') },
  {
    ...
    rarity: 'bronze', image: getImageUrl('Cleopatra') },
  {
    ...
    rarity: 'gold', image: getImageUrl('Frederick Douglass') },
  {
    name: 'Sun Tzu',
    ...
    rarity: 'legendary', image: getImageUrl('Sun Tzu') },
  {
    name: 'Bruce Lee',
    nickname: 'Be Water',
    stats: [
  ...
  // ============================================
  {
    ...
    rarity: 'gold', image: getImageUrl('Mr. Rogers') },
  {
    name: 'Bob Ross',
    ...
    rarity: 'gold', image: getImageUrl('Bob Ross') },
  {
    name: 'Steve Irwin',
    ...
    rarity: 'bronze', image: getImageUrl('Steve Irwin') },
  {
    ...
    rarity: 'gold', image: getImageUrl('Freddie Mercury') },
  {
    ...
    rarity: 'gold', image: getImageUrl('Teddy Roosevelt') },
  {
    name: 'Marie Curie',
    ...
    rarity: 'silver', image: getImageUrl('Marie Curie') },
  {
    ...
    rarity: 'bronze', image: getImageUrl('Harriet Tubman') },
  {
    name: 'Muhammad Ali',
  ...
  // ============================================
  {
    ...
    rarity: 'holo', image: getImageUrl('Keanu Reevos') },
  {
    name: 'Donny DeVito',
    nickname: 'Trash Man',
    stats: [
    ...
    rarity: 'gold', image: getImageUrl('Donny DeVito') },
  {
    ...
    rarity: 'silver', image: getImageUrl('Nicolas Kage') },
  {
    name: 'Snoop Doggo',
    nickname: 'Fo Shizzle',
    stats: [
    ...
    rarity: 'silver', image: getImageUrl('Gordon Ramzay') },
  {
    ...
    rarity: 'bronze', image: getImageUrl('Shaqster') },
  {
    name: 'Marfa Stewart',
    ...
    rarity: 'silver', image: getImageUrl('Marfa Stewart') },
  {
    name: 'Mike Tyzon',
    ...
    rarity: 'legendary', image: getImageUrl('Guy Fiori') },
  {
    ...
    rarity: 'gold', image: getImageUrl('Bad Luck Brian') },
  {
    name: 'Grimace',
    ...
    rarity: 'bronze', image: getImageUrl('Elan Muskrat') },
  {
    ...
    rarity: 'silver', image: getImageUrl('Mark Zuckerbot') },
  {
    name: 'Geoff Bezel',
    ...
    rarity: 'silver', image: getImageUrl('Geoff Bezel') },
  {
    name: 'The Pebble',
    ...
    rarity: 'legendary', image: getImageUrl('The Pebble') },
  {
    name: 'Joe Rogain',
    ...
    rarity: 'bronze', image: getImageUrl('Gary Buseye') },
  {
    ...
    rarity: 'bronze', image: getImageUrl('Charlie Sheenz') },
  {
    name: 'Flavor Flame',
    ...
    rarity: 'gold', image: getImageUrl('Toast Malone') },
  {
    ...
    rarity: 'silver', image: getImageUrl('Isle Boys') },
  {
    name: 'Scumbag Steve',
    ...
    rarity: 'silver', image: getImageUrl('Scumbag Steve') },
    ...
    rarity: 'silver', image: getImageUrl('Elizabeth Homes') },
  {
    ...
    rarity: 'silver', image: getImageUrl('George Santoro') },
  {
    ...
    rarity: 'gold', image: getImageUrl('Adam LeVine') },
  {
    ...
    rarity: 'silver', image: getImageUrl('Coco Siwa') },
  {
    name: 'Wil Smyth',
    ...
    rarity: 'legendary', image: getImageUrl('Wil Smyth') },
  {
    name: 'Logan Pauls',
    ...
    rarity: 'silver', image: getImageUrl('Logan Pauls') },
  {
    ...
    rarity: 'gold', image: getImageUrl('Pepper Bae') },
  {
    ...
    rarity: 'silver', image: getImageUrl('Ben Shapirno') },
  {
    ...
    rarity: 'silver', image: getImageUrl('Travis Scot') },
  {
    name: 'Raegun',
    ...
    rarity: 'silver', image: getImageUrl('Albert Einstein') },
  {
    ...
    rarity: 'gold', image: getImageUrl('Elvis Presley') },
  {
    ...
    rarity: 'gold', image: getImageUrl('Ludwig van Beethoven') },
  {
    ...
    rarity: 'bronze', image: getImageUrl('Wolfgang Amadeus Mozart') },
  {
    ...
    rarity: 'holo', image: getImageUrl('Abraham Lincoln') },
  {
    name: 'Attila the Hun',
    ...
    rarity: 'silver', image: getImageUrl('Attila the Hun') },
  {
    ...
    rarity: 'gold', image: getImageUrl('David Bowie') },
  {
    name: 'Prince',
    ...
    rarity: 'gold', image: getImageUrl('Prince') },
  {
    ...
    rarity: 'holo', image: getImageUrl('Harry Houdini') },
  {
    name: 'Confucius',
    ...
    rarity: 'legendary', image: getImageUrl('Confucius') },
  {
    name: 'Socrates',
