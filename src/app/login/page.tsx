        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700/50 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 mt-2">
              {isSignUp 
                ? 'Sign up to start collecting cards!' 
                : 'Sign in to continue your collection'}
            </p>
            {isSignUp && (
              <div className="mt-3 px-4 py-2 bg-cyan-500/10 border border-cyan-500/30 rounded-lg">
                <p className="text-cyan-400 text-sm">🎁 New users get 1,000 coins free!</p>
              </div>
            )}
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-3 bg-white hover:bg-gray-100 rounded-xl text-gray-800 font-semibold transition-colors disabled:opacity-50"
          >
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-xl text-white font-semibold hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
